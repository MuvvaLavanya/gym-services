...
class TraineeControllerTest {
	...
	void testAddTrainee() throws Exception {
		...
		Mockito.when(traineeService.addTrainee(Mockito.any(TraineeDto.class))).thenReturn(credentialsDto);
    ...
    void testUpdateTrainerProfile() throws Exception {
        ...
        Mockito.when(traineeService.updateTraineeProfile(Mockito.any(TraineeUpdateDto.class)))
    ...
    void testGetTraineeTrainings() throws Exception {
        ...
        Mockito.when(traineeService.getTraineeTrainingsList(Mockito.any(TraineeTrainingsList.class)))
